...
import { getRegionMetrics, type RegionMetrics } from '../../services/atlas'
...
export default function RegionOverview() {
    ...
    return (
        <div className="container" style={{maxWidth:1200}}>
            <Card title={`${data.name} · ${t('region.overview')}`} right={<button className="btn ghost" onClick={()=>nav('/atlas')}>{t('globe.backToMap')}</button>}>
