        ...
        <header className="qc-header" onMouseLeave={() => setOpen(null)}>
            <div className="qc-header__inner">
                    ...
                    <div className="qc-nav__item" onMouseEnter={() => setOpen('token')}>
                        ...
                        {open === 'token' && (
                            <div className="qc-menu">
                                ...
                                <Link to="/ecosystem/explorer/tokens" className="qc-menu__item">{t('nav.commonTokens')}</Link>
                            </div>
                        )}
                    </div>
                ...
                <div className="qc-actions">
                    ...
                    <Link to="/ecosystem/wallets/quanta/auth/login" className="qc-btn ghost">{t('actions.connectWallet')}</Link>
                    <Link to="/ecosystem/wallets/quanta/auth/login" className="qc-btn primary">{t('actions.login')}</Link>
                </div>
            </div>
        </header>
    );
